        ...
        <div className="flex items-center gap-2 pt-1">
          {phone && (
            <a
              ...
              className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-[#090d16] shadow-sm transition-all hover:border-[#84cc16]"
              aria-label="Call client"
            >
              <Phone className="h-6 w-6 text-[#84cc16]" strokeWidth={2} />
              {extraPhoneCount > 0 && (
                <span className="absolute -right-1 -top-1 min-w-5 rounded-full bg-[#090d16] px-1 text-[10px] font-black leading-5 text-white">
                  +{extraPhoneCount}
                </span>
              )}
            </a>
