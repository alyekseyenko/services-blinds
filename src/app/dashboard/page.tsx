...
export default function Dashboard() {
  ...
  const handleToggleLocationConsent = useCallback(() => {
    ...
    localStorage.setItem(CLIENT_PREF_KEYS.LOCATION_SHARING, String(nextState));
  ...
  useEffect(() => {
    ...
    if ("geolocation" in navigator) {
      ...
      const sendLocation = () => {
        const consent = typeof window !== "undefined" && localStorage.getItem(CLIENT_PREF_KEYS.LOCATION_SHARING) === "true";
        if (!consent) return;
