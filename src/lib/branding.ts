...
export const APP_NAME =
  process.env.NEXT_PUBLIC_APP_NAME || "Blinds Technical Services";
export const APP_SHORT_NAME =
  process.env.NEXT_PUBLIC_APP_SHORT_NAME || "BTS";
/** Generic app logo — UI, map HQ, tab favicon via generated icons. */
