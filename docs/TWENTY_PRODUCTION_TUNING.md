...
Deploy, backup, and CRM tuning helpers are maintained **outside this repository** (local machine or VPS only). The public Git repo contains only the application source code.
